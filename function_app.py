...
# job template - 01
@app.timer_trigger(schedule = "0 40 14 * * *", arg_name = "myTimer", run_on_startup = True, use_monitor = False) 
...
# job template - 02
@app.timer_trigger(schedule = "0 1 13 * * *", arg_name = "myTimer", run_on_startup = True, use_monitor = False) 
